...
namespace NeoSmart.UnitTest.Controllers
{
    ...
    public class TrainingCalendarsControllerTest
    {
        ...
        private readonly Mock<IGenericUnitOfWork<Session>> _unitOfWorkMock;
     ...
     .Options;
            _unitOfWorkMock = new Mock<IGenericUnitOfWork<Session>>();
        ...
        public async Task GetAsync_ReturnsOkResult()
        {
            ...
            var controller = new SessionsController(_unitOfWorkMock.Object, context, _mockFileStorage.Object);
