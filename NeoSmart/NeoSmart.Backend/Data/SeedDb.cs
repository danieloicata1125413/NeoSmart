...
namespace NeoSmart.BackEnd.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckRolesAsycn()
        {
            ...
            await _userHelper.CheckRoleAsync(UserType.Lider.ToString());
            await _userHelper.CheckRoleAsync(UserType.Capacitador.ToString());
        ...
        private async Task CheckCountriesAsync()
        {
            if (!_context.Countries.Any())
            {
                ...
                if (country == null)
                {
                    country = new() { Cod = 57, Name = "COLOMBIA", States = new List<State>(), Status = true };
                    var state = new State() { Cod = 5, Name = "ANTIOQUIA", Cities = new List<City>(), Status = true };
                    state.Cities.Add(new City() { Cod = 1, Name = "ABRIAQUÍ", Status = true });
                    state.Cities.Add(new City { Cod = 20, Name = "ALEJANDRIA", Status = true });
                    state.Cities.Add(new City { Cod = 30, Name = "AMAGÁ", Status = true });
                    state.Cities.Add(new City { Cod = 31, Name = "AMALFI", Status = true });
                    state.Cities.Add(new City { Cod = 36, Name = "ANDES", Status = true });
                    state.Cities.Add(new City { Cod = 37, Name = "ANGELÓPOLIS", Status = true });
                    state.Cities.Add(new City { Cod = 38, Name = "ANGOSTURA", Status = true });
                    state.Cities.Add(new City { Cod = 40, Name = "ANORÍ", Status = true });
                    state.Cities.Add(new City { Cod = 44, Name = "ANZÁ", Status = true });
                    state.Cities.Add(new City { Cod = 45, Name = "APARTADÓ", Status = true });
                    state.Cities.Add(new City { Cod = 57, Name = "ARBOLETES", Status = true });
                    state.Cities.Add(new City { Cod = 60, Name = "ARGELIA", Status = true });
                    state.Cities.Add(new City { Cod = 65, Name = "ARMENIA", Status = true });
                    state.Cities.Add(new City { Cod = 81, Name = "BARBOSA", Status = true });
                    state.Cities.Add(new City { Cod = 91, Name = "BELLO", Status = true });
                    state.Cities.Add(new City { Cod = 92, Name = "BELMIRA", Status = true });
                    state.Cities.Add(new City { Cod = 100, Name = "BETANIA", Status = true });
                    state.Cities.Add(new City { Cod = 102, Name = "BETULIA", Status = true });
                    state.Cities.Add(new City { Cod = 110, Name = "BOLÍVAR", Status = true });
                    state.Cities.Add(new City { Cod = 116, Name = "BRICEÑO", Status = true });
                    state.Cities.Add(new City { Cod = 129, Name = "BURÍTICA", Status = true });
                    state.Cities.Add(new City { Cod = 135, Name = "CAICEDO", Status = true });
                    state.Cities.Add(new City { Cod = 144, Name = "CALDAS", Status = true });
                    state.Cities.Add(new City { Cod = 151, Name = "CAMPAMENTO", Status = true });
                    state.Cities.Add(new City { Cod = 162, Name = "CARACOLÍ", Status = true });
                    state.Cities.Add(new City { Cod = 163, Name = "CARAMANTA", Status = true });
