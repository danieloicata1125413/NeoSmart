...
namespace NeoSmart.Backend.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckDocumentTypesAsync()
        {
            ...
            {
                _context.DocumentTypes.Add(new DocumentType { Name = "NIT", Description = "NUMERO DE IDENTIFICACION TRIBUTARIA" });
                _context.DocumentTypes.Add(new DocumentType { Name = "CC", Description = "CEDULA DE CIUDADANIA" });
                _context.DocumentTypes.Add(new DocumentType { Name = "LM", Description = "LIBRETA MILITAR" });
                _context.DocumentTypes.Add(new DocumentType { Name = "TI", Description = "TARJETA DE IDENTIDAD" });
                _context.DocumentTypes.Add(new DocumentType { Name = "TE", Description = "TARJETA DE EXTRANJERIA" });
                _context.DocumentTypes.Add(new DocumentType { Name = "TDE", Description = "TIPO DE DOCUMENTO EXTRANJERO" });
                _context.DocumentTypes.Add(new DocumentType { Name = "RUT", Description = "REGISTRO UNICO TRIBUTARIO" });
                _context.DocumentTypes.Add(new DocumentType { Name = "RC", Description = "REGISTRO CIVIL DE NACIMIENTO" });
                _context.DocumentTypes.Add(new DocumentType { Name = "CE", Description = "CEDULA DE EXTRANJERIA" });
                _context.DocumentTypes.Add(new DocumentType { Name = "PS", Description = "PASAPORTE" });
                _context.DocumentTypes.Add(new DocumentType { Name = "GENER", Description = "GENERICOS" });
        ...
        private async Task CheckTrainingsAsync()
        {
            if (!_context.Topics.Any())
            {
                _context.Trainings.Add(new Training { Name = "Excel" });
                _context.Trainings.Add(new Training { Name = "Seguridad informatica" });
                _context.Trainings.Add(new Training { Name = "Office" });
                _context.Trainings.Add(new Training { Name = "Hseq" });
                _context.Trainings.Add(new Training { Name = "Riesgo locativo" });
                await _context.SaveChangesAsync();
            }
        }
    }
